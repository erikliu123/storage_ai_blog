...
## 更新摘要
**变更内容**
- 新增 ASPLOS 2025 和 SIGMOD 2025 会议数据结构
- 所有新增会议数据完全遵循统一的 PaperData 接口规范
- 增强了论文数据的可视化展示能力，包含架构图引用和详细贡献分析
- 扩展了会议专题页面的覆盖范围，新增两个顶级会议的数据管理
...
**更新** 新增了 ASPLOS 2025 和 SIGMOD 2025 会议数据，这两个新增会议完全遵循统一的 PaperData 接口规范，为项目扩展了更多顶级会议的覆盖范围。
...
**图表来源**
- [conferences.ts:1-229](file://src/data/conferences.ts#L1-L229)
...
**更新** 新增的 ASPLOS 2025 和 SIGMOD 2025 会议数据完全遵循此统一接口规范，包含完整的架构图引用和详细的技术贡献分析。
...
**更新** 新增的 ASPLOS 2025 和 SIGMOD 2025 页面实现了与现有页面相同的架构图条件渲染和展示逻辑，增强了论文的可视化展示效果。

**章节来源**
- [asplos2025.ts:15-147](file://src/data/asplos2025.ts#L15-L147)
- [sigmod2025.ts:15-159](file://src/data/sigmod2025.ts#L15-L159)
- [conferences.ts:15-229](file://src/data/conferences.ts#L15-L229)
...
**更新** 新增了 ASPLOS 2025 会议数据，包含 12 篇论文，涵盖架构与系统、机器学习系统、存储与内存、安全与可靠性四个专题领域。
...
**更新** 新增了 SIGMOD 2025 会议数据，包含 14 篇论文，涵盖数据库系统、查询处理、数据管理、分布式系统四个专题领域。
...
**更新** 新增了架构图数量统计（diagramCount），用于统计包含架构图的论文数量。
...
**更新** 所有 ATC 2024 论文都已添加架构图字段，增强了论文的可视化展示效果。

**章节来源**
- [Atc2024.tsx:1-148](file://src/pages/Atc2024.tsx#L1-L148)
- [conferences.ts:124-229](file://src/data/conferences.ts#L124-L229)
...
**更新** 所有 OSDI 2025 论文都已添加架构图字段，所有论文都包含详细的贡献列表、优点和局限性说明。
...
**更新** 新增了 ASPLOS 2025 和 SIGMOD 2025 的架构图字段条件渲染逻辑，只有当论文包含架构图时才显示相应的标签和图片。
...
**更新** 本次更新显著增强了论文数据的可视化展示能力，通过新增的 ASPLOS 2025 和 SIGMOD 2025 会议数据，项目现已覆盖存储系统领域的多个顶级会议。新增的架构图字段（archDiagram）和改进的论文描述详细程度，为用户提供了更丰富的技术洞察和更好的阅读体验。所有会议论文都已标准化地添加了架构图字段，确保了数据的一致性和完整性。页面组件中的条件渲染逻辑确保了架构图的高效加载和展示，提升了整体的用户体验。

整体架构简洁、可扩展性强，为存储技术博客的会议数据管理提供了良好的基础。新增的 ASPLOS 2025 和 SIGMOD 2025 功能为未来的可视化分析和数据挖掘提供了更多的可能性，进一步丰富了项目的内容生态。