...
export const atc2024Papers: PaperData[] = [
  ...
  },
  {
    ...
    archDiagram: '/images/alps-arch.png',
  ...
  },
  {
    ...
    archDiagram: '/images/streambox-arch.png',
  ...
  // ML Inference
  {
    ...
    archDiagram: '/images/cachedattention-arch.png',
  ...
  },
  {
    ...
    archDiagram: '/images/puzzle-arch.png',
  ...
  // Storage
  {
    ...
    archDiagram: '/images/scalaafa-arch.png',
  ...
  },
  {
    ...
    archDiagram: '/images/fastcommit-arch.png',
  ...
  },
  {
    ...
    archDiagram: '/images/zms-arch.png',
  ...
  {
    id: 'atc2024-teebox',
    title: 'TEEbox: A Trusted Execution Environment for Secure Serverless Computing',
    authors: ['Security Research Team'],
    session: 'Security',
    summary: '基于 TEE 的安全 Serverless 计算环境，保护用户代码和数据隐私。',
    archDiagram: '/images/jiagu-arch.png',
    keywords: ['TEE', 'Serverless Security', 'Enclave'],
    contributions: ['设计 TEE 隔离架构', '实现安全函数执行', '性能开销 < 10%'],
    pros: ['✓ 安全性高', '✓ 支持多种 TEE', '✓ 开销低'],
    cons: ['✗ TEE 硬件依赖', '✗ 内存受限'],
  },
  {
    id: 'atc2024-mlguard',
    title: 'MLGuard: Defending Against Adversarial Attacks in Production ML Systems',
    authors: ['ML Security Team'],
    session: 'Security',
    summary: '生产环境 ML 系统的对抗攻击防御机制。',
    archDiagram: '/images/alps-arch.png',
    keywords: ['ML Security', 'Adversarial Defense', 'Production ML'],
    contributions: ['设计对抗检测器', '实现动态防御策略', '检测率 95%+'],
    pros: ['✓ 检测精度高', '✓ 实时防御', '✓ 通用性强'],
    cons: ['✗ 计算开销', '✗ 可能误报'],
  },
  // Networking
  {
    id: 'atc2024-rdmaio',
    title: 'RDMA-IO: High-Performance Network I/O with RDMA for Datacenter Applications',
    authors: ['Network Systems Team'],
    session: 'Networking',
    summary: '基于 RDMA 的高性能网络 I/O 框架，优化数据中心应用通信。',
    archDiagram: '/images/streambox-arch.png',
    keywords: ['RDMA', 'Network I/O', 'Datacenter'],
    contributions: ['设计 RDMA 通信协议', '实现零拷贝传输', '延迟降低 50%'],
    pros: ['✓ 极低延迟', '✓ 高吞吐', '✓ CPU 开销低'],
    cons: ['✗ RDMA 硬件成本', '✗ 部署复杂'],
  },
  {
    id: 'atc2024-trafficopt',
    title: 'TrafficOpt: Intelligent Traffic Scheduling for Multi-Tenant Datacenter Networks',
