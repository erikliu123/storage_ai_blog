...
export const fast2022Papers: ArchivePaperData[] = [
  {
    ...
    cons: ['✗ 编码复杂度增加', '✗ 需要固件支持'],
    sections: [
      { title: '1. 问题背景', content: 'QLC/PLC NAND可靠性下降，传统纠错码开销增大。WOM(Write-Once Memory)编码允许有限次重写，但传统方案效率低。' },
      { title: '2. WOM-v设计', content: '变长编码适应不同数据模式，动态调整编码策略减少写入放大，结合LDPC实现更高纠错能力。' },
      { title: '3. 性能评估', content: '可靠性提升15%，寿命延长20%，编码开销<3%。' },
    ],
    performanceData: [
